...
class TestNVDecompressApplication : public mercury::Application
{
	bool isRunning = true;
	float value = 0.0f;
	...
	int particlesNum2 = 0;
public:
	TestNVDecompressApplication();
	virtual ~TestNVDecompressApplication() override;
...
TestNVDecompressApplication::TestNVDecompressApplication()
{
	config.appName = "TestNVDecompressApplication Application";
}
...
bool TestNVDecompressApplication::Initialize()
{
...
bool TestNVDecompressApplication::Shutdown()
{
	return true;
}
...
bool TestNVDecompressApplication::Render()
{
...
bool TestNVDecompressApplication::Update()
{
	value += 0.1f;
...
void TestNVDecompressApplication::OnApplicationClose()
{
	isRunning = false;
}

//static TestNVDecompressApplication myApp;