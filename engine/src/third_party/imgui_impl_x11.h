...
IMGUI_IMPL_API bool     ImGui_ImplX11_Init(xcb_connection_t *connection, xcb_drawable_t *win);
IMGUI_IMPL_API void     ImGui_ImplX11_Shutdown();
IMGUI_IMPL_API void     ImGui_ImplX11_NewFrame();
IMGUI_IMPL_API bool     ImGui_ImplX11_Event(xcb_generic_event_t *event);