...
#if defined(MERCURY_PHYSICS_API_BULLET) || defined(MERCURY_PHYSICS_API_PHYSX)
#define MERCURY_USE_PHYSICS
#endif

#if defined(MERCURY_SOUND_API_MINIAUDIO) || defined(MERCURY_SOUND_API_FMOD) || defined(MERCURY_SOUND_API_WWISE)
#define MERCURY_USE_SOUND
#endif
