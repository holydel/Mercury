...
class HelloSpritesApplication : public mercury::Application
{
	bool isRunning = true;
...
public:
	HelloSpritesApplication();
	virtual ~HelloSpritesApplication() override;
...
HelloSpritesApplication::HelloSpritesApplication()
{
	config.appName = "HelloSpritesApplication";
...
bool HelloSpritesApplication::Initialize()
{
...
bool HelloSpritesApplication::Shutdown()
{
	return true;
}

bool HelloSpritesApplication::PreRender()
{
	if (!mat.isValid())
	{
...
bool HelloSpritesApplication::Render()
{
	if (mat.isValid())
	{
...
bool HelloSpritesApplication::Update()
{
	for (auto& r : allRectangles)
	{
		r.x += r.dx;
...
void HelloSpritesApplication::OnApplicationClose()
{
	isRunning = false;
}

//static HelloSpritesApplication myApp;